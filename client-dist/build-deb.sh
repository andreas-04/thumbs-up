...
echo "=========================================="
echo ""
echo "Package location: dist/thumbsup-client_1.0.0-1_all.deb"
echo ""
echo "To install:"
echo "  sudo dpkg -i dist/thumbsup-client_1.0.0-1_all.deb"
echo "  sudo apt-get install -f  # Fix any dependency issues"
echo ""
echo "Or test in Docker:"
echo "  docker run --rm -v \$(pwd)/dist:/dist -it ubuntu:22.04 bash"
echo "  # apt-get update && apt-get install -y /dist/thumbsup-client_1.0.0-1_all.deb"
echo ""
